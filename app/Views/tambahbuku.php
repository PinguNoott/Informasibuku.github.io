...
<body>
    <div class="form-container">
        <form action="<?= base_url('home/aksi_t_buku') ?>" method="post" enctype="multipart/form-data">
            <label for="judul">Judul Buku</label>
            <input type="text" id="judul" name="judul" placeholder="Masukkan Judul Buku" required>

            <label for="penulis">Penulis</label>
            <input type="text" id="penulis" name="penulis" placeholder="Masukkan Penulis" required>
